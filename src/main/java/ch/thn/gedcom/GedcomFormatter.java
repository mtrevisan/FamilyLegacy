...
public class GedcomFormatter {
	...
	public synchronized static GedcomDateFormat getGedcomDateFormat(String gedcomDate) {
		...
		if (RegexHelper.matches(gedcomDate, gedcomDateFormatYearMonthDay)) {
			return GedcomDateFormat.YEAR_MONTH_DAY;
		} else if (RegexHelper.matches(gedcomDate, gedcomDateFormatYearMonth)) {
			return GedcomDateFormat.YEAR_MONTH;
		} else if (RegexHelper.matches(gedcomDate, gedcomDateFormatYear)) {
