...
public class GedcomStoreBlock{
	...
	protected boolean parse(LinkedList<String> block) throws GedcomParseException{
		...
		if(lineIndex == null){
			...
			throw new GedcomParseException("On line '" + block.get(0) + "'. The format of the line index is not valid. " + "A index can either be 'n' or '+' followed by a number 1-99.");
		}
		...
		if(subBlock.size() > 0){
			return parseSubBlock(subBlock, lastStoreLine);
		}
	 ...
	 * @return
	 */
	public LinkedList<String> getPathToStoreLine(String tagOrStructureName, String tag, boolean withXRef, boolean withValue){
	 ...
	 * @return
	 */
	public LinkedList<String> getPathToStoreLine(String tagOrStructureName, boolean withXRef, boolean withValue){
	 ...
	 * @return
	 */
	private LinkedList<String> getPathToStoreLine(String tagOrStructureName, String tag, boolean lookForXRefAndValueVariation, boolean withXRef, boolean withValue){
