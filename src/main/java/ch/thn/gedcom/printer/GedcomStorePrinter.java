...
public class GedcomStorePrinter{
	 ...
	 * @return
	 */
	private static StringBuffer preparePrint(GedcomStoreBlock storeBlock, int limitToLevel, boolean includeStructures, int levelAdjust){
		StringBuffer sb = new StringBuffer();
	 ...
	 * @return
	 */
	private static StringBuffer preparePrint(GedcomStoreLine storeLine, int limitToLevel, boolean includeStructures, int levelAdjust){
		StringBuffer sb = new StringBuffer();
