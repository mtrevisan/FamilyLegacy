 ...
 * </pre>
 */
public class _DateDialog extends JDialog{
	 ...
	 */
	public static _DateDialog createNew(final Dialog parent, final FLEFModel model, final String title){
		return new _DateDialog(parent, model, title, null);
	}
	 ...
	 */
	public static _DateDialog createEdit(final Dialog parent, final FLEFModel model, final String title,
			final FLEFRecord existingEntry){
		if(existingEntry == null)
			throw new IllegalArgumentException("existingEntry cannot be null");

		return new _DateDialog(parent, model, title, existingEntry);
	}


	private _DateDialog(final Dialog parent, final FLEFModel model, final String title, final FLEFRecord initialDate){
	...
	public static FLEFRecord showDateDialog(final Dialog parent, final FLEFModel model, final String title,
		...
		final _DateDialog dialog = createEdit(parent, model, title, initialDate);
