...
public class RelationshipTypeSelectionDialog extends JDialog{
	 ...
	 */
	public RelationshipTypeSelectionDialog(final Dialog owner, final List<Item> items, final String[] allowedTypes){
	 ...
	 */
	public static List<String> showDialog(final Dialog owner, final List<Item> items, final String[] allowedTypes){
