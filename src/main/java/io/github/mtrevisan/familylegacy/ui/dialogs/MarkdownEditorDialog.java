...
public class MarkdownEditorDialog extends JDialog{
	...
	public MarkdownEditorDialog(final Flef store, final Frame parent){
		super(parent, true);
...
//			}
		...
		final MigLayout layout = new MigLayout("debug,insets 0", "[400,grow]0[]");
		setLayout(layout);
...
//	}
	...
	public static void main(final String[] args) throws GedcomParseException, GedcomGrammarParseException{
		...
		EventQueue.invokeLater(() -> {
			final MarkdownEditorDialog dialog = new MarkdownEditorDialog(store, new JFrame());
