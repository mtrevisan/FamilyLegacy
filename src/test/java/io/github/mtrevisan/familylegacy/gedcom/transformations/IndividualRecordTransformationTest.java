...
class IndividualRecordTransformationTest{
	...
	void to(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: I1, tag: INDI, children: [{tag: RESN, value: RESTRICTION_NOTICE}, {tag: NAME, value: NAME_PERSONAL}, {tag: SEX, value: SEX_VALUE}, {tag: BIRT}, {tag: DEAT}, {tag: NATI}, {tag: NCHI}, {tag: BAPL}, {tag: ENDL}, {id: F1, tag: FAMC}, {id: F2, tag: FAMC}, {id: F3, tag: FAMS}, {id: F4, tag: FAMS}, {id: SUBM1, tag: SUBM}, {id: SUBM2, tag: SUBM}, {id: ASS1, tag: ASSO}, {id: ASS2, tag: ASSO}, {id: ALI1, tag: ALIA}, {id: ALI2, tag: ALIA}, {id: SUBM1, tag: ANCI}, {id: SUBM2, tag: ANCI}, {id: SUBM1, tag: DESI}, {id: SUBM2, tag: DESI}, {tag: RFN, value: PERMANENT_RECORD_FILE_NUMBER}, {tag: AFN, value: ANCESTRAL_FILE_NUMBER}, {tag: REFN, value: USER_REFERENCE_NUMBER1, children: [{tag: TYPE, value: USER_REFERENCE_TYPE1}]}, {tag: REFN, value: USER_REFERENCE_NUMBER2, children: [{tag: TYPE, value: USER_REFERENCE_TYPE2}]}, {tag: RIN, value: AUTOMATED_RECORD_ID}, {tag: CHAN, children: [{tag: DATE, value: CHANGE_DATE}]}, {id: N1, tag: NOTE}, {id: S1, tag: SOUR}, {id: D1, tag: OBJE}]}, {id: N1, tag: NOTE, value: SUBMITTER_TEXT}]}]", root.toString());

		final Transformation t = new IndividualRecordTransformation();
		t.to(extractSubStructure(root, "PARENT", "INDI"), root);

		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: I1, tag: INDIVIDUAL, children: [{tag: RESTRICTION, value: RESTRICTION_NOTICE}, {tag: NAME, children: [{tag: PERSONAL_NAME, value: NAME_PERSONAL}]}, {tag: SEX, value: SEX_VALUE}, {tag: EVENT, value: BIRTH}, {tag: EVENT, value: DEATH}, {tag: ATTRIBUTE, value: ORIGIN}, {tag: ATTRIBUTE, value: CHILDREN_COUNT}, {id: F1, tag: FAMILY_CHILD}, {id: F2, tag: FAMILY_CHILD}, {id: F3, tag: FAMILY_SPOUSE}, {id: F4, tag: FAMILY_SPOUSE}, {id: SUBM1, tag: SUBM}, {id: SUBM2, tag: SUBM}, {id: ASS1, tag: ASSOCIATION, children: [{tag: TYPE, value: INDIVIDUAL}]}, {id: ASS2, tag: ASSOCIATION, children: [{tag: TYPE, value: INDIVIDUAL}]}, {id: ALI1, tag: ALIAS}, {id: ALI2, tag: ALIAS}, {tag: _REFN, value: USER_REFERENCE_NUMBER1, children: [{tag: TYPE, value: USER_REFERENCE_TYPE1}]}, {tag: _REFN, value: USER_REFERENCE_NUMBER2, children: [{tag: TYPE, value: USER_REFERENCE_TYPE2}]}, {tag: _RIN, value: AUTOMATED_RECORD_ID}, {tag: CHANGE, children: [{tag: DATE, value: CHANGE_DATE}]}, {id: N1, tag: NOTE}, {id: S1, tag: SOURCE}, {id: D1, tag: DOCUMENT}]}, {id: N1, tag: NOTE, value: SUBMITTER_TEXT}]}]", root.toString());
	}
