...
class IndividualTransformationTest{
	...
	void to(){
		final GedcomNode individual = transformerTo.create("INDI")
			...
			.addChild(transformerTo.create("NAME")
				...
				.addChild(transformerTo.create("SOUR")
					.addChildValue("EXTRACT", "TEXT_FROM_SOURCE1")
				...
				.addChild(transformerTo.create("FONE")
					...
					.addChild(transformerTo.create("SOUR")
						.addChildValue("EXTRACT", "TEXT_FROM_SOURCE2")
				...
				.addChild(transformerTo.create("ROMN")
					...
					.addChild(transformerTo.create("SOUR")
						.addChildValue("EXTRACT", "TEXT_FROM_SOURCE3")
			...
			.addChild(transformerTo.create("ASSO")
				...
				.addChild(transformerTo.create("SOUR")
					.addChildValue("EXTRACT", "TEXT_FROM_SOURCE9")
			...
			.addChild(transformerTo.create("SOUR")
				.addChildValue("EXTRACT", "TEXT_FROM_SOURCE10")
		...
		Assertions.assertEquals("id: P5, tag: PLACE, children: [{tag: ADDRESS, value: ADDRESS_LINE5 - ADDRESS_LINE5 - ADDRESS_LINE51 - ADDRESS_LINE52 - ADDRESS_LINE53}, {tag: CITY, value: ADDRESS_CITY5}, {tag: STATE, value: ADDRESS_STATE5}, {tag: COUNTRY, value: ADDRESS_COUNTRY5}, {tag: MAP, children: [{tag: LATITUDE, value: PLACE_LATITUDE5}, {tag: LONGITUDE, value: PLACE_LONGITUDE5}]}, {id: N-12, tag: NOTE}]", destination.getPlaces().get(4).toString());
	}
	...
	void from() throws GedcomGrammarParseException{
		final GedcomNode individual = transformerFrom.create("INDIVIDUAL")
			...
			.addChild(transformerFrom.create("FAMILY_CHILD")
				.addChild(transformerFrom.create("PEDIGREE")
					.addChildValue("SPOUSE1", "PEDIGREE_LINKAGE_TYPE1")
					.addChildValue("SPOUSE2", "PEDIGREE_LINKAGE_TYPE2")
				)
		...
		Assertions.assertEquals("id: I1, tag: INDI, children: [{tag: RESN, value: RESTRICTION_NOTICE}, {tag: NAME, value: TITLE_PIECE1 NAME_PIECE1 NAME_PIECE_SUFFIX1, children: [{tag: TYPE, value: NAME_TYPE}, {tag: NPFX, value: TITLE_PIECE1}, {tag: GIVN, value: NAME_PIECE1}, {tag: NSFX, value: NAME_PIECE_SUFFIX1}, {tag: FONE, value: TITLE_PIECE2 NAME_PIECE2 NAME_PIECE_SUFFIX2, children: [{tag: NPFX, value: TITLE_PIECE2}, {tag: GIVN, value: NAME_PIECE2}, {tag: NSFX, value: NAME_PIECE_SUFFIX2}]}, {tag: ROMN, value: TITLE_PIECE3 NAME_PIECE3 NAME_PIECE_SUFFIX3, children: [{tag: NPFX, value: TITLE_PIECE3}, {tag: GIVN, value: NAME_PIECE3}, {tag: NSFX, value: NAME_PIECE_SUFFIX3}]}, {id: N1, tag: NOTE}, {id: S1, tag: SOUR}]}, {tag: SEX, value: SEX_VALUE}, {tag: FAMC, children: [{tag: PEDI, value: SPOUSE1: PEDIGREE_LINKAGE_TYPE1, SPOUSE2: PEDIGREE_LINKAGE_TYPE2}, {tag: STAT, value: CERTAINTY}, {id: N1, tag: NOTE}]}, {tag: FAMS, children: [{id: N2, tag: NOTE}]}, {id: I1, tag: ASSO, children: [{tag: TYPE, value: ASSOCIATION_TYPE}, {tag: RELA, value: RELATION_IS_DESCRIPTOR}, {id: N1, tag: NOTE}, {id: S1, tag: SOUR}]}, {id: I1, tag: ALIA, children: [{id: N2, tag: NOTE}]}, {tag: BIRT, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_BIRTH}, {tag: DATE, value: DATE_TIME_VALUE}, {tag: AGNC, value: RESPONSIBLE_AGENCY}, {tag: CAUS, value: CAUSE_OF_EVENT}, {tag: RESN, value: RESTRICTION_NOTICE}, {id: F1, tag: FAMC}, {id: N1, tag: NOTE}, {id: S1, tag: SOUR}]}, {tag: ADOP, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_ADOPTION}, {id: F1, tag: FAMC, children: [{tag: ADOP, value: ADOPTED_BY_WHICH_PARENT}]}]}, {tag: DEAT, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_DEATH}]}, {tag: CAST, value: CASTE, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_CASTE}]}, {tag: DSCR, value: CHARACTERISTIC, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_ATTR1}]}, {tag: RESI, value: RESIDENCE, children: [{tag: TYPE, value: EVENT_OR_FACT_CLASSIFICATION_ATTR2}]}, {tag: FACT, value: _FAMILY_NICKNAME, children: [{tag: TYPE, value: Family Nickname}]}, {id: N2, tag: NOTE}]", destination.getIndividuals().get(0).toString());
	}
