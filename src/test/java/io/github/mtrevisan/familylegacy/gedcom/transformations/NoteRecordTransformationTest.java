...
class NoteRecordTransformationTest{
	...
	void to1(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: N1, tag: NOTE, value: SUBMITTER_TEXTSUBMITTER_TEXT, children: [{tag: _REFN, value: USER_REFERENCE_NUMBER, children: [{tag: TYPE, value: USER_REFERENCE_TYPE}]}, {tag: _RIN, value: AUTOMATED_RECORD_ID}, {id: S1, tag: SOURCE}, {tag: CHANGE, children: [{tag: DATE, value: CHANGE_DATE}]}]}]}, {id: S1, tag: SOUR}]", root.toString());
	}
