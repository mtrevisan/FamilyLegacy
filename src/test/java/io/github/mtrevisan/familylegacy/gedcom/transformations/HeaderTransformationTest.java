...
class HeaderTransformationTest{
	...
	private GedcomNode composeHEAD(){
	...
	private GedcomNode composeHEADER(){
		final GedcomNode header = GedcomNode.create("HEADER");

		header.addChild(GedcomNode.create("SOURCE")
			.withValue("APPROVED_SYSTEM_ID")
			...
			.addChild(GedcomNode.create("CORPORATE")
				...
				.addChild(GedcomNode.create("PLACE")
					.withID("P1"))));
		header.addChild(GedcomNode.create("SUBMITTER")
			.withID("SUBM1"));
		header.addChild(GedcomNode.create("COPYRIGHT")
			.withValue("COPYRIGHT_GEDCOM_FILE"));
		header.addChild(GedcomNode.create("PROTOCOL_VERSION")
			.withValue("VERSION_NUMBER"));
		header.addChild(GedcomNode.create("CHARSET")
			.withValue("UTF-8"));
		header.addChild(GedcomNode.create("NOTE")
			.withID("N1"));
