...
class RepositoryRecordTransformationTest{
	...
	void to1(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: R1, tag: REPOSITORY, children: [{tag: NAME, value: NAME_OF_REPOSITORY}, {tag: ADDRESS, value: ADDRESS_LINE}, {id: N1, tag: NOTE}, {tag: _REFN, value: USER_REFERENCE_NUMBER, children: [{tag: _TYPE, value: USER_REFERENCE_TYPE}]}, {tag: _RIN, value: AUTOMATED_RECORD_ID}, {tag: CHANGE, children: [{tag: DATE, value: CHANGE_DATE}]}]}]}]", root.toString());
	}
