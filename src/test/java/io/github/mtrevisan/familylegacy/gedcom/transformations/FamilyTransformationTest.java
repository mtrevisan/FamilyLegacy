...
class FamilyTransformationTest{
	...
	@Test
	void to(){
		final GedcomNode individual = GedcomNode.create("FAM")
			.withID("F1")
	...
	void from() throws GedcomGrammarParseException{
		final GedcomNode individual = GedcomNode.create("FAMILY")
			.withID("F1")
			.addChild(GedcomNode.create("NAME")
