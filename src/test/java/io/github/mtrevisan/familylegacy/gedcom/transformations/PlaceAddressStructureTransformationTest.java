...
class PlaceAddressStructureTransformationTest{
	...
	void placeTo(){
		...
		final Transformation t = new PlaceAddressStructureTransformation();
		t.to(extractSubStructure(root, "PARENT"), root);

		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: N1, tag: NOTE, value: SUBMITTER_TEXT}]}]", root.toString());
	}
	...
	void addressTo(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{tag: ADDRESS, value: ADDRESS_LINEADDRESS_LINE - ADDRESS_LINE1 - ADDRESS_LINE2 - ADDRESS_LINE3, children: [{tag: CITY, value: ADDRESS_CITY}, {tag: STATE, value: ADDRESS_STATE}, {tag: POSTAL_CODE, value: ADDRESS_POSTAL_CODE}, {tag: COUNTRY, value: ADDRESS_COUNTRY}, {tag: PHONE, value: PHONE_NUMBER}, {tag: PHONE, value: ADDRESS_FAX, children: [{tag: TYPE, value: FAX}]}, {tag: EMAIL, value: ADDRESS_EMAIL}, {tag: WWW, value: ADDRESS_WEB_PAGE}]}]}]", root.toString());
	}
	...
	void placeAddressTo(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{tag: ADDRESS, value: ADDRESS_LINEADDRESS_LINE - ADDRESS_LINE1 - ADDRESS_LINE2 - ADDRESS_LINE3, children: [{tag: CITY, value: ADDRESS_CITY}, {tag: STATE, value: ADDRESS_STATE}, {tag: POSTAL_CODE, value: ADDRESS_POSTAL_CODE}, {tag: COUNTRY, value: ADDRESS_COUNTRY}, {tag: PHONE, value: PHONE_NUMBER1}, {tag: PHONE, value: PHONE_NUMBER2}, {tag: PHONE, value: ADDRESS_FAX1, children: [{tag: TYPE, value: FAX}]}, {tag: PHONE, value: ADDRESS_FAX2, children: [{tag: TYPE, value: FAX}]}, {tag: EMAIL, value: ADDRESS_EMAIL1}, {tag: EMAIL, value: ADDRESS_EMAIL2}, {tag: WWW, value: ADDRESS_WEB_PAGE1}, {tag: WWW, value: ADDRESS_WEB_PAGE2}, {tag: MAP, children: [{tag: LATITUDE, value: PLACE_LATITUDE}, {tag: LONGITUDE, value: PLACE_LONGITUDE}]}, {id: N1, tag: NOTE}]}, {id: N1, tag: NOTE, value: SUBMITTER_TEXT}]}]", root.toString());
	}
	...
	void placeAddressFrom(){
		...
		final Transformation t = new PlaceAddressStructureTransformation();
		t.from(root, extractSubStructure(root, "PARENT"));

		Assertions.assertEquals("cchildren: [{tag: PARENT, children: [{tag: PLACE, children: [{tag: DATA, value: CHANGE_DATE, children: [{tag: LOCALE, value: en_US}, {tag: COMPANY, value: COMPANY_NAME}, {tag: APARTMENT, value: ADDRESS_APARTMENT}, {tag: NUMBER, value: ADDRESS_NUMBER}, {tag: STREET, value: ADDRESS_STREET, children: [{tag: TYPE, value: ADDRESS_STREET_TYPE}]}, {tag: DISTRICT, value: ADDRESS_DISTRICT}, {tag: TOWN, value: ADDRESS_TOWN}, {tag: CITY, value: ADDRESS_CITY}, {tag: COUNTY, value: ADDRESS_COUNTY}, {tag: STATE, value: ADDRESS_STATE}, {tag: POSTAL_CODE, value: ADDRESS_POSTAL_CODE}, {tag: COUNTRY, value: ADDRESS_COUNTRY}, {tag: MAP, children: [{tag: LATITUDE, value: PLACE_LATITUDE}, {tag: LONGITUDE, value: PLACE_LONGITUDE}]}, {tag: PHONE, value: PHONE_NUMBER, children: [{tag: TYPE, value: PHONE_NUMBER_TYPE}]}, {tag: EMAIL, value: ADDRESS_EMAIL, children: [{tag: TYPE, value: ADDRESS_EMAIL_TYPE}]}, {tag: WWW, value: ADDRESS_WEB_PAGE, children: [{tag: TYPE, value: ADDRESS_WEB_PAGE_TYPE}]}, {tag: DATE, value: DATE_VALUE}, {tag: NOTE, value: N1}, {tag: SUBMITTER, value: SUBM1}, {tag: RESTRICTION, value: RESTRICTION_NOTICE}, {tag: TIME, value: TIME_VALUE}]}]}]}, {id: N1, tag: NOTE, value: SUBMITTER_TEXT}]", root.toString());
	}
