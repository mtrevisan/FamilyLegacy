...
class PlaceAddressStructureTransformationTest{
	...
	void placeTo(){
		...
		Assertions.assertEquals("children: [{tag: PARENT, children: [{id: N1, tag: NOTE, value: SUBMITTER_TEXT}, {tag: ADDRESS, value: PLACE_NAME, children: [{id: N1, tag: NOTE}]}]}]", root.toString());
	}
