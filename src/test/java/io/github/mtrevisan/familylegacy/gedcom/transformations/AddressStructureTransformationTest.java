...
class AddressStructureTransformationTest{
	...
	void to(){
		...
		Assertions.assertEquals("children: [{tag: ADDR, value: ADDRESS_LINE, children: [{tag: CONT, value: ADDRESS_LINE}, {tag: ADR1, value: ADDRESS_LINE1}, {tag: ADR2, value: ADDRESS_LINE2}, {tag: ADR3, value: ADDRESS_LINE3}, {tag: CITY, value: ADDRESS_CITY}, {tag: STAE, value: ADDRESS_STATE}, {tag: POST, value: ADDRESS_POSTAL_CODE}, {id: ADDRESS_COUNTRY, tag: CTRY}]}, {tag: PHON, value: PHONE_NUMBER}, {tag: EMAIL, value: ADDRESS_EMAIL}, {tag: FAX, value: ADDRESS_FAX}, {tag: WWW, value: ADDRESS_WEB_PAGE}]", root.toString());
	...
	void from(){
		...
		final Transformation t = new PlaceStructureTransformation();
		t.from(extractSubStructure(root, "PARENT", "PLAC"), root);
		deleteTag(extractSubStructure(root, "PARENT"), "PLAC");
